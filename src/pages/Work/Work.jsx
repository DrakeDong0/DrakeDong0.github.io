    ...
    return (
        <div className="work-container">
            ...
            <div className="tech-bar">
                ...
                <a target="_blank" href="https://tailwindcss.com/docs/installation"><img className="tech-img" alt-text="Tailwind icon" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original-wordmark.svg" /></a>
            ...
            <div className="work-exp-container">
                <WorkExperience
                    ...
                    responsibilities={[
                        ...
                        "- Wrote new API endpoints using Golang and developed MongoDB queries.",
                        "- Configured, routed, and deployed project site with Docker and Portainer.",
                        "- Developed a new database utility allowing backups and updates without remigration.",
                        "- Helped overhaul frontend website using React.tsx and Tailwind."
                    ]}
                />
                <WorkExperience
                    logo={silai_logo}
